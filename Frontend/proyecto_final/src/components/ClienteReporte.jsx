...
export const ClienteReporte = () => {
  ...
  return (
    <>
      ...
      <div className="
      lg:w-[90%] lg:h-auto grid grid-col-2 bg-white drop-shadow-2xl h-[60%] w-[90%] mx-auto mt-[8%] overflow-x-auto overflow-y-auto">
        <Table striped bordered hover size="sm" style={{ width: "50em", height: "5em" }} className="xl:mx-auto xl:text-[30px] lg:text-[25px] text-center">
          <thead>
            <tr>
              <th>Nombre</th>
              <th>Apellido</th>
