...
export const DashProducts = () => {
  ...
  const handleGeneratePDF = (userId = null) => {
    try {
      ...
      const selectedProduct = products.find((user) => user._id === userId);

      const filename = userId
        ? `producto_${selectedProduct.nombre}.pdf`
        : "producto.pdf";
      ...
      if (selectedProduct) {
        ...
        const data = [
          [
            ...
            selectedProduct.categorias.map((cat) => cat.nombre).join(", "),
            selectedProduct.categorias
              .map((cat) => cat.subcategorias.join(", "))
              .join("; "),
                    ...
                    <td>
                      <div className="flex flex-row">
                        ...
                        <Button
                          ...
                          onClick={() => handleGeneratePDF(product._id)}
                        >
                          <IoPrintOutline />
                        </Button>
                        <Button
