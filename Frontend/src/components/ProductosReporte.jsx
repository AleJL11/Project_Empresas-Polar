  ...
  return (
    <>
      ...
      <div className="xl:w-[80%] lg:h-40 grid grid-rows grid-flow-col-1 h-32 w-[90%] mx-auto mt-4 drop-shadow-2xl bg-white">
        <h5 className="lg:text-[25px] ml-4 mt-4">Seleccionar tipo de reporte por venta:</h5>
        <select
          value={reportType}
          onChange={(e) => setReportType(e.target.value)}
          className="min-[1920px]:w-[60%] xl:w-[80%] lg:text-[30px] lg:h-14 mt-1 -ml-2 border-none focus:ring-indigo-500 focus:border-indigo-500 block p-2 w-[90%] h-9 mx-auto"
        >
